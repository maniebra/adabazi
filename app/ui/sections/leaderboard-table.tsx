...
export default function LeaderboardTable({className}: LeaderboardTableProps) {
    ...
    return (
        ...
        >
            <div
                className="grid grid-cols-[60px_1fr_80px] items-center bg-slate-50/80 px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 border-b border-slate-100 backdrop-blur-md z-10">
                <div>رتبه</div>
                ...
                >
                  {toFarsiDigits(rank)}
                            ...
                            <div className="flex items-center gap-3 overflow-hidden">
                                <div
                                    className="h-2 w-2 shrink-0 rounded-full bg-slate-200 group-hover:bg-indigo-400 transition-colors"/>
            ...
            {sorted.length > 0 && (
                <div
                    className="bg-slate-50 px-6 py-2 border-t border-slate-100 text-[10px] text-slate-400 text-left uppercase font-medium">
